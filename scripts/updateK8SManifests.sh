...
REPO_URL="https://${AZURE_DEVOPS_ORG}:${AZURE_DEVOPS_PAT}@dev.azure.com/${AZURE_DEVOPS_ORG}/${AZURE_DEVOPS_PROJECT}/_git/${AZURE_DEVOPS_REPO}.git"

git clone "$REPO_URL" /tmp/temp_repo

cd /tmp/temp_repo

sed -i "s|image:.*|image: azeacruatpipe-e6hndxgtfafgfad7.azurecr.io/$2:$3|g" K8S/$1-deployment.yml
